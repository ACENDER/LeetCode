...
def hongbao(total, num):
    ...
    while (i < num):
        ...
        # total=3.5 i=2,2<4,max=3.5-0.01_抽象数据类型和面向对象编程*(4-2)=3.5-0.02=3.48,k=0,k=2,max=3.48/2=1.24 money=(1,124),假设20，取余得到0.2，total=3.5-0.2=3.3
        # total=3.3 i=3,3<4,max=3.3-0.01_抽象数据类型和面向对象编程(4-3)=3.29,k=0,k=1,max=3.3,money=(1,330),假设130，取余得1.3，total=3.3-1.3=2
